...
`harness/tools/source_archives.sha256`) and refuses a missing, unpinned or mismatching one. The measurement harness (`harness/`, 118 files with their own sha256 manifest)
