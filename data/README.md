...
| `perf/campaign-f3deebfbab60/flag-<app>/` | the upstream flag `-tsan-instrument-func-entry-exit=false` on stock and on our configurations, N = 5, 21-22 Sep 2026 (UTC stamps of 21 Sep), the campaign's set; measured and not claimed (`CLAIMS.md`, the section on the flag) | `f3deebfbab60` | the flag's rows are reported with the suite's gate result beside them |
