...
|---|---|---|---|---|---|---|---|---|
| ffmpeg | orig | orig | 5 | 2.936 [2.907, 2.977] | — (all 4 subtests within 5%) | — | — | pinned |
| ffmpeg | tsan | tsan | 5 | — | — (all 4 subtests within 5%) | 2.94 [2.91, 2.98] | — | pinned |
| ffmpeg | tsan-dom_peeling-ea-lo-st-swmr | AllOpt+peel | 5 | 1.005 [0.998, 1.021] | — (all 4 subtests within 5%) | 2.92 [2.90, 2.93] | — | pinned |
| ffmpeg | tsan-stmt | tsan-stmt | 5 | 1.113 [1.098, 1.131] | — (all 4 subtests within 5%) | 2.64 [2.61, 2.67] | — | pinned |
