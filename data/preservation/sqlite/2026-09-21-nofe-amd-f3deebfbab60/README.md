...
The application check for the upstream flag (measured, not claimed; not this paper's contribution). Run on the second
host (AMD EPYC 9115, 64 threads, Ubuntu 24.04) from a scratch clone of the artifact, taken on 21 Sep, inside the
...
`python3 harness/tools/preservation/preservation_verdict.py --results-dir <this dir>/logs --app sqlite --baseline tsan`.
