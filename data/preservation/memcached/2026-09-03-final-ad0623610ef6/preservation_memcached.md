...
| tsan-sound | 10 | 10.9 ± 2.2 | 9.9 ± 2.2 | 9.9 ± 2.2 | 17 | 17 | 11 | data race:109 |
| tsan-all | 10 | 13.4 ± 0.8 | 8.3 ± 0.7 | 8.3 ± 0.7 | 10 | 10 | 4 | data race:134 |
...
| 5/10 | 1/10 | 0/10 | `data race | read:conn_new@memcached.c:753 | write:rbuf_release@memcached.c:417 | heap:conn_new@memcached.c:656` |
| 10/10 | 10/10 | 0/10 | `data race | read:conn_new@memcached.c:761 | write:clock_handler@memcached.c | global:current_time` |
| 4/10 | 1/10 | 0/10 | `data race | read:conn_release_items@memcached.c:840 | write:conn_new@memcached.c:766 | heap:conn_new@memcached.c:656` |
| 10/10 | 10/10 | 10/10 | `data race | read:do_item_link@items.c:495 | write:clock_handler@memcached.c | global:current_time` |
| 4/10 | 1/10 | 0/10 | `data race | read:drive_machine@memcached.c:3162 | write:conn_new@memcached.c:694 | heap:conn_new@memcached.c:656` |
...
| 2/10 | 3/10 | 3/10 | `data race | read:lru_maintainer_juggle@items.c:1426 | write:clock_handler@memcached.c | global:current_time` |
| 10/10 | 9/10 | 10/10 | `data race | read:lru_maintainer_thread@items.c:1671 | write:clock_handler@memcached.c | global:current_time` |
...
| 4/10 | 1/10 | 0/10 | `data race | read:try_read_network@memcached.c:2530 | write:conn_new@memcached.c:784 | heap:conn_new@memcached.c:656` |
| 5/10 | 1/10 | 0/10 | `data race | write:conn_close@memcached.c:933 | write:conn_new@memcached.c:752 | heap:conn_new@memcached.c:656` |
...
| 5/10 | 1/10 | 0/10 | `data race | write:conn_new@memcached.c:749 | write:conn_set_state@memcached.c:1011 | heap:conn_new@memcached.c:656` |
...
| 5/10 | 1/10 | 0/10 | `data race | write:conn_new@memcached.c:753 | write:rbuf_release@memcached.c:417 | heap:conn_new@memcached.c:656` |
